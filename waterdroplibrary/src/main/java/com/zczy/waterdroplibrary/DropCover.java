...
public class DropCover extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private ExplosionUpdateHandler mExplosionUpdateHandler;
    ...
    public void init(float x, float y) {
        ...
        mExplosionUpdateHandler = new ExplosionUpdateHandler();
    }
    ...
    public void finish(View target, float x, float y) {
        ...
        if (distance > mMaxDistance) {
            ...
            mThread = new ExplosionUpdateThread(getHolder(), this,mExplosionUpdateHandler);
    ...
    public class ExplosionUpdateHandler extends Handler {
        public ExplosionUpdateHandler() {
        }

        public ExplosionUpdateHandler(Looper L) {
            super(L);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            String stateStr = tmpBundle.getString("state");
            if ("ExplosionComplete".equals(stateStr)){
                DropCover.this.clearViews();
            }
